            ...
            <div class="col-md-3">
                ...
                <div class="form-group">
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-right font-size-sm" aria-labelledby="dropdown-analytics-overview" style="">
            ...
            <div class="col-md-6 col-xl-3">
                <a class="block block-rounded block-link-shadow bg-primary" href="javascript:void(0)">
                    <div class="block-content block-content-full d-flex align-items-center justify-content-between">
                        ...
                        <div>
                            <i class="fa fa-2x fa-wallet text-primary-lighter"></i>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-md-6 col-xl-3">
                <a class="block block-rounded block-link-shadow bg-warning" href="javascript:void(0)">
                    <div class="block-content block-content-full d-flex align-items-center justify-content-between">
                        ...
                        <div>
                            <i class="fa fa-2x fa-hand-holding-medical text-black-50"></i>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-md-6 col-xl-3">
                <a class="block block-rounded block-link-shadow bg-danger" href="javascript:void(0)">
                    <div class="block-content block-content-full d-flex align-items-center justify-content-between">
                        ...
                        <div>
                            <i class="fa fa-2x fa-clock text-black-50"></i>
                        </div>
                    </div>
                </a>
            </div>
