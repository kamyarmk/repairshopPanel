...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <!-- Page JS Plugins CSS -->
        <link rel="stylesheet" href="{{ asset('js/plugins/bootstrap-tourist/bootstrap-tourist.css') }}">
    ...
    >
        ...
        <div id="page-container" class="sidebar-o enable-page-overlay sidebar-dark side-scroll 
         ...
         page-header-fixed main-content-narrow">
                ...
                <div class="bg-image" style="background-image: url('{{ asset('media/various/bg_side_overlay_header.jpg') }}');">
                    <div class="bg-primary-op">
                        <div class="content-header">
                            ...
                            <!-- User Info -->
                            <div class="ml-2">
                                <a class="text-white font-w600" href="javascript:void(0)">{{ Auth::user()->user_name }}</a>
                                <div class="text-white-75 font-size-sm">{{ Auth::user()->job_title }}</div>
                            </div>
                            <!-- END User Info -->
                ...
                <div class="bg-header-dark">
                    <div class="content-header bg-white-10">
                        ...
                        <a class="font-w600 text-white tracking-wide" href="/">
                            ...
                            @if(session()->get('locale') == 'fa')
                                <img src="{{ asset('/media/Logo-fa.png') }}" alt="" style="width: 150px">
                            @else
                                <img src="{{ asset('/media/English-Logo.png') }}" alt="" style="width: 150px">
                            @endif
                        ...
                        <ul class="nav-main">
                            ...
                            <li class="nav-main-item{{ request()->is('project/*') ? ' open' : '' }}">
                                ...
                                <ul class="nav-main-submenu">
                                    ...
                                    <li class="nav-main-item">
                                        <a class="nav-main-link{{ request()->is('project/problems') ? ' active' : '' }}" href="/project/problems">
                                            <span class="nav-main-link-name">{{ __('Problems') }}</span>
                                        </a>
                                    </li>
                                    <li class="nav-main-item">
                                        <a class="nav-main-link{{ request()->is('project/qc') ? ' active' : '' }}" href="/project/qc">
                                            <span class="nav-main-link-name">{{ __('Quality Check') }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="true" href="#">
                                    ...
                                    <span class="nav-main-link-name">{{ __('Language') }}</span>
                                </a>
                                <ul class="nav-main-submenu">
                                    <li class="nav-main-item">
            ...
            <header id="page-header">
                ...
                <div class="content-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="dropdown">
                                <button type="button" class="btn btn-primary dropdown-toggle" id="dropdown-default-hero-primary" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="ml-1 d-none d-sm-inline-block">{{ __('Language') }}</span>
                                </button>
                                <div class="dropdown-menu" aria-labelledby="dropdown-default-hero-primary" style="">
                                    <a class="dropdown-item" href="/language/en">{{ __('English') }}</a>
                                    <a class="dropdown-item" href="/language/fa">{{ __('Persian') }}</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <!-- Tour Button -->
                            <button type="button" class="btn btn-dual bg-success text-white" onclick="startTour()">
                                <i class="fa fa-hands-helping"></i> <span class="ml-1 d-none d-sm-inline-block">{{ __('Tour') }}</span>
                            </button>
                        <!-- Tour Button -->
                        <!-- User Dropdown -->
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0" aria-labelledby="page-header-notifications-dropdown">
                                ...
                                <div class="p-2 border-top">
                                    <a class="btn btn-light btn-block text-center" href="/notifications">
                                        <i class="fa fa-fw fa-eye mr-1"></i> {{ __('View All') }}
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <header_search
                    csrf="{{ csrf_token() }}"
                    placeholder="{{ __('Search or hit ESC..') }}"
                ></header_search>
                <!-- END Header Search -->
                ...
                <div class="content py-0">
                    <div class="row font-size-sm">
                        <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-right">
                            {{ __('Crafted with') }} <i class="fa fa-heart text-danger"></i> {{ __('by') }} <a class="font-w600" href="https://dartweb.net" target="_blank">{{ __('Dartweb') }}</a>
                        </div>
                        <div class="col-sm-6 order-sm-1 text-center text-sm-left">
                            <a class="font-w600" href="#" target="_blank">{{ __('Resepto') }}</a> &copy; <span data-toggle="year-copy"></span>
                        </div>
                    </div>
                </div>
            </footer>
        ...
        <!-- Page JS Plugins -->
        <script src="{{ asset('js/plugins/bootstrap-tourist/bootstrap-tourist.min.js') }}"></script>

        <!-- Page JS Code -->
        <!-- <script src="{{ asset('js/pages/be_comp_tour.min.js') }}"></script> -->
