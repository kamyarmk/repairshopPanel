                ...
                <div class="row my-3">
                    <div class="col-md-6 d-md-flex align-items-md-center">
                        <div class="py-4 py-md-0 text-center text-md-left invisible" data-toggle="appear">
                            <h1 class="font-size-h2 mb-2">{{ __('Dashboard') }}</h1>
                            <h2 class="font-size-lg font-w400 text-muted mb-0">{{ __('Welcome to your overview') }}</h2>
                        </div>
                    </div>
                    <div class="col-md-6 d-md-flex align-items-md-center">
                        <div class="row w-100 text-center">
                            <div class="col-6 col-xl-4 offset-xl-4 invisible" data-toggle="appear" data-timeout="300">
                                ...
                                <p class="font-size-sm font-w600 text-muted text-uppercase mb-0">
                                    <i class="far fa-chart-bar opacity-75 mr-1"></i> {{__('Sales')}}
                                </p>
                            </div>
                            <div class="col-6 col-xl-4 invisible" data-toggle="appear" data-timeout="600">
                                ...
                                <p class="font-size-sm font-w600 text-muted text-uppercase mb-0">
                                    <i class="far fa-chart-bar opacity-75 mr-1"></i> {{ __('Earnings') }}
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="content">
        ...
        <div class="block block-rounded block-mode-loading-refresh invisible" data-toggle="appear">
            <div class="block-header block-header-default">
                <h3 class="block-title">{{ __('Earnings') }}</h3>
                        ...
                        <table class="table table-striped table-hover table-borderless table-vcenter font-size-sm">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="font-w600 font-size-base">Lisa Jenkins</div>
