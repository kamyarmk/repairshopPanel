                                ...
                                <tr>
                                    <td class="text-center">
                                        <a class="font-w600" href="/project/edit">
                                            <strong>ORD.<?php echo e($Device->id); ?></strong>
                                        </a>
                                    </td>
                                    <td class="font-size-base">
                                        <span class="badge badge-pill badge-success <?php echo e($Device->condition); ?>"><?php echo e($Device->condition); ?></span>
                                    </td>
                                    <td class="d-none d-xl-table-cell">
                                        <a class="font-w600" href="be_pages_ecom_customer.html"><?php echo e($Device->Users->first_name); ?> <?php echo e($Device->Users->last_name); ?></a>
                                    </td>
                                    <td class="d-none d-xl-table-cell text-center">
                                        <a class="font-w600" href="/project/edit"><?php echo e($Device->Devices->device_name); ?> / <?php echo e($Device->Devices->device_type); ?></a>
                                    </td>
                                    <td class="d-none d-sm-table-cell text-center">
                                        <strong><?php echo e($Device->IMEI); ?></strong>
                                    </td>
                                    <td class="d-none d-sm-table-cell text-center"><?php echo e($Device->created_at); ?></td>
                                    <td class="text-center font-size-base">
                                        <a class="btn btn-sm btn-alt-secondary" href="/project/edit/<?php echo e($Device->id); ?>">
