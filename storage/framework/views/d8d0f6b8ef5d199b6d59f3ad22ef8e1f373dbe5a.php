<?php $__env->startSection('css_after'); ?>
    <!-- Page JS Plugins CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('js/plugins/summernote/summernote-bs4.css')); ?>">
...
<?php $__env->startSection('js_after'); ?>
    <!-- Page JS Plugins -->
    <script src="<?php echo e(asset('js/plugins/summernote/summernote-bs4.min.js')); ?>"></script>

    <!-- Page JS Helpers (Summernote plugin) -->
    <script>jQuery(function(){Dashmix.helpers('summernote');});</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/kamyar/Documents/Projects/FixIt/repairshopPanel/resources/views/message/chat.blade.php ENDPATH**/ ?>