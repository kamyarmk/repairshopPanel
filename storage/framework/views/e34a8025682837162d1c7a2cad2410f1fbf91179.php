                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-primary" role="navigation">
                    ...
                    <div class="collapse navbar-collapse navbar-left col-8">
                        <div id="navigation">
                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(route('RegisterDevice')); ?>" class="nav-link"> <span><i class="ti-files"></i></span><span> <?php echo e(__('Register Device')); ?> </span> </a>
                                </li>

                                <li class="nav-item">
                                    <a href="<?php echo e(route('DeviceList')); ?>" class="nav-link"><span><i class="ti-spray"></i></span><span> <?php echo e(__('List Device')); ?> </span> </a>
                                </li>

                                <li class="nav-item">
                                    <a href="<?php echo e(route('UserList')); ?>" class="nav-link"> <span><i class="ti-widget"></i></span><span> <?php echo e(__('Users')); ?> </span> </a>
                                </li>

                                <li class="nav-item">
                                    <a href="<?php echo e(route('Devices')); ?>" class="nav-link"> <span><i class="ti-widget"></i></span><span> <?php echo e(__('Reports')); ?> </span> </a>
                    ...
                    <div class="collapse navbar-collapse navbar-left col-2">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item dropdown">
                                <a href="" class="dropdown-toggle menu-right-item profile" data-toggle="dropdown" aria-expanded="true"><img src="<?php echo e(asset('/images/users/avatar-1.jpg')); ?>" alt="user-img" class="rounded-circle w-50"> </a>
